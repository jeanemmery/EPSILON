...
@section('content')
@if (Cart::count() > 0)
<div class="px-4 px-lg-0" style="width: 100%;">
    <div class="pb-5">
        <div class="container">
            <div class="row">
                                    ...
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            ...
                                            <div class="ml-3 d-inline-block align-middle">
                                                <h5 class="mb-0"> <a href="{{ route('products.show', ['slug' => $product->model->slug]) }}" class="text d-inline-block align-middle" style="color: #45007F;">{{ $product->model->title }}</a></h5><span class="text-muted font-weight-normal font-italic d-block">Catégories: @foreach ($product->model->categories as $category)
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                    ...
                    <form action="{{ route('cart.store.coupon') }}" method="POST">
                        ...
                        <div class="input-group mb-4 border rounded-pill p-2">
                            ...
                            <div class="input-group-append border-0">
                                <button id="button-addon3" type="submit" class="btn px-4 rounded-pill" style="background-color: #45007F; color:white;"><i class="fa fa-gift mr-2"></i>Appliquer le coupon</button>
                            </div>
                        </div>
                    </form>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        @endif
                        </ul><a href="{{ route('checkout.index') }}" class="btn rounded-pill py-2 btn-block" style="background-color: #45007F; color:white;"><i class="fa fa-credit-card" aria-hidden="true"></i> Passer à la caisse</a>
                    </div>
                </div>
            </div>
        </div>
